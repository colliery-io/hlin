//! The light's components: one big light, since when, the last hour as a strip,
//! and which service it watches.
//!
//! The light changes on the five minutes, which nobody writes and so nothing
//! announces; this asks again every thirty seconds while it is in view.
...
pub fn Status() -> impl IntoView {
    ...
    let drawn = loaded_view(reading, move |reading| {
