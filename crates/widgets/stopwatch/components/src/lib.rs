//! The stopwatch's components: the time, ticking, and the buttons a stopwatch has.
//!
//! The platform says how much had elapsed when it answered; this counts
...
use hlin_widget_ui::{Loaded, Request, loaded_view, use_widget};
use leptos::prelude::*;
...
pub fn Stopwatch() -> impl IntoView {
    ...
    let drawn = loaded_view(face, move |face| {
