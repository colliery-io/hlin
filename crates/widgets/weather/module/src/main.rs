//! The weather's module: your home city large, the next hours under it, the
...
//! server; the module only draws it.
...
fn main() {
    start("weather", |widget: Widget| {
        ...
        loaded_view(outlook, move |outlook| {
