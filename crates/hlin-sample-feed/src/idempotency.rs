...
//! have landed. So this platform remembers which keys it has acted on and what
//! it answered, and answers a repeat with the same thing instead of posting a
//! second copy.
//!
...
//!   person who is unmuted, or who fixes a typo in a too-long post, is not held
//!   to an answer about a write that never occurred.
